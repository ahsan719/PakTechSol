      ...
      <ul class="navbar-nav" id="navbar-nav">
        ...
        <li class="nav-item">
              ...
              <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarPot" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="sidebarLanding">
                                <i class="ri-rhythm-fill"></i> <span data-key="t-landing">Manage Team</span>
                            </a>
                            <div class="menu-dropdown collapse" id="sidebarPot" style="">
                                <ul class="nav nav-sm flex-column">
                                   <li class="nav-item">
                                     <a href="add-team.php" class="nav-link" data-key="t-one-page"> Add New </a>
                                   </li>
                                   <li class="nav-item">
                                      <a href="team.php" class="nav-link" data-key="t-nft-landing"> Team List </a>
                                   </li>
                               </ul>
                            </div>
                        </li>
